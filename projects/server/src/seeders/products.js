  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert(
      ...
      [
        ...
        {
          id: 11,
          product_name: "Baseus D02 Pro Foldable Headphone Bluetooth Wireless/Wired V5.0",
        ...
        {
          id: 13,
          product_name: "TA-Headset Bluetooth Gaming Telinga Kucing - Headphone Kuping P47",
          product_description: `Deskripsi produk :
